...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- <div v-for="author in authors" :key="author.id">{{ author }} : {{ author.birthYear }}</div>  -->
      <ul>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(Hours, KindOfDay) in bookstores.openningHouse" :key="KindOfDay">
          {{ KindOfDay }} open in: {{ Hours.open }} close in:{{ Hours.close }}
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <li :style="{ color: 'red' }">{{ orwell }}</li>
      <li :style="{ color: 'red' }">ID: {{ orwell.id }} , name: {{ orwell.name }}</li>
    </section>
  </div>
</template>
...
const allFamousWorks = computed(() => {
  ...
  return authors.map((author) => author.famousWorks)
})
